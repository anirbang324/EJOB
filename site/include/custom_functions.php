...
/* Login check for talent */
 function CheckCandidateLogin(){
	if(isset($_SESSION['candidate_login']) AND ($_SESSION['candidate_login']==1))
	{ // logged in
...
/* Login check for talent */
 function CheckCompanyLogin(){
	if(isset($_SESSION['company_login']) AND ($_SESSION['company_login']==1))
	{ // logged in
		//echo $_SESSION['talent_login'];
	...
	{
		header('location:index.php?op=companyinvalid');
	}
}
